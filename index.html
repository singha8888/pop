...
<img id="banner" src="virus-images.jpeg">
   ...
   <!--  <img id="banner" src="virus-images.jpeg"> -->
    <div id="disclaimer" style="text-align: center;">
        <span class="support">Microsoft Support: 
...
<!-- <div id="poptxt" class="lightbox">
    <div class="ilb top">
        <div class="headers ilb" style="border-bottom: 1px solid #d6d5d5;">
            <span id="txtadd" class="fl title"><span class="fl ilb"><img src="microsoft.png" class="logo3"></span> System Warning</span>
            <span id="txts1" class="fl title2"><a href="#">Learn more on www.support.microsoft.com</a></span>
...
<div id="bottom">
        <img id="badge" src="support.png"><span class="title3">Microsoft </span>
        <ul>
            <li>
                <a href="#">
                    <div class="fr button">
                        <span id="addtochromebutton">Update</span>
                    </div>
                </a>
            </li>
            <li>
...
<div id="pop_up_new" class="cardcontainer" style="cursor: none;">
    ...
    <p style="padding-bottom: 0px; color:#fff; font-size:14px;">Call Microsoft Support: <strong>
            <script>document.write(8884796555)</script> (Toll-Free)</strong></p>
